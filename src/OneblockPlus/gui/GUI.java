...
import OneblockPlus.ChestItems;
import OneblockPlus.Messages;
import OneblockPlus.PlayerInfo;
import OneblockPlus.WorldGuard.OBWorldGuard;
...
public class GUI {
	...
	public static void topGUI(Player p) {
		...
		PlayerInfo inf = OneblockPlus.Oneblock.gettop(0);
		...
		inf = OneblockPlus.Oneblock.gettop(1);
		...
		inf = OneblockPlus.Oneblock.gettop(2);
		...
		inf = OneblockPlus.Oneblock.gettop(3);
		...
		inf = OneblockPlus.Oneblock.gettop(4);
		...
		inf = OneblockPlus.Oneblock.gettop(5);
